...
KERNEL_PATH="target/hifive_premier_p550/debug/p550_bench_vmmode"
BENCH_PATH="${REPO_ROOT}/benchmarks/vmmode-bench/target/hifive_premier_p550/debug/vmmode-bench"
